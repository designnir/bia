...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn about the Big Island Air Pilots who are the best in the business. More than being just pilots, they are also the best Hawaii air tour guides.">
        <meta name="author" content="">
        <link rel="icon" href="favicon.ico">

        <title>Big Island Air Pilots - The Best Hawaii Air Tour Guides</title>
                    ...
                    <div class="col-sm-10 col-md-9">
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="pilots.php">PILOTS</a></li>
        ...
        <div class="container-fluid inner-bg">
           <div class="content-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title"><span>Pilots</span></h1>
                        
                        <div class="row">
                            <div class="col-md-4">
                               <img src="images/steve.jpg" alt="steve" class="img-responsive" />
                                <h3>Steve Lupkey</h3>
                                <p>Big Island Air Tour Pilot</p>
                                <p>Flight Hours: 6000+</p>
                            </div>
                            <div class="col-md-4">
                               <img src="images/rex.jpg" alt="rex" class="img-responsive" />
                                <h3>Rex Brumley</h3>
                                <p>Big Island Air Tour Pilot</p>
                                <p>Flight Hours: 10000+</p>
                            </div>
                            <!--<div class="col-md-4">
                               <img src="images/anthony.jpg" alt="anthony" class="img-responsive" />
                                <h3>Anthony Fink</h3>
                                <p>Big Island Air Tour Pilot</p>
                                <p>Flight Hours: 6000+</p>
                            </div>-->
                            <div class="col-md-4">
                               <img src="images/darryl2.jpg" alt="rex" class="img-responsive" />
                                <h3>Darryl Grace</h3>
								<p>Big Island Air Tour Pilot</p>
								<p>Flight Hours: 5000+</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="images/plane2.jpg" alt="plane" class="img-responsive" />
                            </div>
                            <div class="col-md-8">
                                <h1 class="page-title"><span>ABOUT: BIG ISLAND AIR PILOTS</span></h1>
                                <p>Only the best pilots fly for Big Island Air.</p>
                                <p>Our pilots are the most experienced tour pilots in Hawaii. Not only does each one have extensive knowledge of the history, culture and geology of the Island, all are trained above and beyond the standards of the Federal Aviation Administration.</p>
                                <p>For training and testing, we use FlightSafety International, the leader in corporate aviation training. Fortune 500 companies and over 30 countries worldwide trust FlightSafety in the training of their pilots.</p>
                            </div>
                        </div>
