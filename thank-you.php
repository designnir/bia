           ...
           <div class="content-area">
            <div class="container">
                <div class="major-tour-inner">
                    <div class="row">
						<div class="col-md-12">
							<h1 class="page-title"><span>THANK YOU FOR YOUR SUBMISSION!</span></h1>
							<div class="alert alert-success">Your reservation request has been submitted successfully, we will contact you shortly.</div>
						</div>
					</div>
                </div><!-- major tour -->
            </div>
