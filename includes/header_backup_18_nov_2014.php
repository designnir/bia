...
<div id="header">
    ...
    <div id="banner">
    	<img src="images/banner3.png" alt="" title="" />
    </div>
    ...
    <div class="tour">
        ...
        <p class="price">$345 <span class="listed-price">$449.00</span></p>
    ...
    <div class="tour">
        ...
        <div class="right">
        <p><img src="images/offer-logo.png" alt="" /></p>
        <p class="price">$388 <span class="listed-price">$449.00</span></p>
    ...
    <div class="tour">
        ...
        <div class="right">
        <p><img src="images/offer-logo.png" alt="" /></p>
        <p class="price">$159<span class="listed-price">$159</span></p>
