...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Big Island Air offers a range of air tours in Kona Hawaii. You can book among the Sunset, Circle Island & VIP Air tours.">
        <meta name="author" content="">
        <link rel="icon" href="favicon.ico">

        <title>Air Tours in Kona Hawaii - Big Island Air - Sunset, VIP & Circle Island</title>
                ...
                <div class="major-tour-inner">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="short-description">Your VIP Air Adventure starts and ends in Maui so forget the hassle of checking out of your hotel only to check in to a new one. See the best of Maui and the IBg Island with Big Island Air! View Haleakala Crater</p>
                            <div class="row">
                                <div class="col-md-6 col-xs-6">
