...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Enjoy amazing photos of the Kona Hawaii air tours by Big Island Air. See the volcanoes, sea & landscape of Hawaii.">
        <meta name="author" content="">
        <link rel="icon" href="favicon.ico">

        <title>Photo Gallery for Kona Hawaii Air Tours</title>
      ...
      <div class="container-fluid inner-bg">
         <div class="content-area">
          ...
          <div class="container">
             ...
             <div class="row">
                 <div class="col-md-12">
                     <h1 class="page-title"><span>Photo Gallery</span></h1>
                 </div>
             </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-3">
                      <a class="#" href="images/gallery/15138421_1517474331612867_1911596928865449149_o.jpg" data-lightbox="example-set" data-title="<a href='reservation.php?tour=circle' class='btn btn-primary booknowbtn-gallery'>Book Now <i class='fa fa-arrow-right' aria-hidden='true'></i></a>"><img class="img-responsive" src="images/gallery/15138421_1517474331612867_1911596928865449149_o.jpg" alt=""/></a>
                  </div>
                  
                  <div class="col-md-3">
                      <a class="#" href="images/gallery/15123238_1517474464946187_8993695689509443100_o.jpg" data-lightbox="example-set" data-title="<a href='reservation.php?tour=circle' class='btn btn-primary booknowbtn-gallery'>Book Now <i class='fa fa-arrow-right' aria-hidden='true'></i></a>"><img class="img-responsive" src="images/gallery/15123238_1517474464946187_8993695689509443100_o.jpg" alt="" /></a>
                  </div>
                  
                  <div class="col-md-3">
                      <a class="#" href="images/gallery/15110280_1517474314946202_331878864059636902_o.jpg" data-lightbox="example-set" data-title="<a href='reservation.php?tour=circle' class='btn btn-primary booknowbtn-gallery'>Book Now <i class='fa fa-arrow-right' aria-hidden='true'></i></a>"><img class="img-responsive" src="images/gallery/15110280_1517474314946202_331878864059636902_o.jpg" alt="" /></a>
                  </div>
                  
                  <div class="col-md-3">
                      <a class="#" href="images/gallery/15042005_1517474338279533_5073266537019805878_o.jpg" data-lightbox="example-set" data-title="<a href='reservation.php?tour=circle' class='btn btn-primary booknowbtn-gallery'>Book Now <i class='fa fa-arrow-right' aria-hidden='true'></i></a>"><img class="img-responsive" src="images/gallery/15042005_1517474338279533_5073266537019805878_o.jpg" alt="" /></a>
                  </div>
